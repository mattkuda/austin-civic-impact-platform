      ...
      <div className="container max-w-7xl mx-auto py-8">
        ...
        <section className="mb-8">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-semibold text-gray-700">Recent Submissions</h2>
          ...
          <div className="space-y-4">
            {submissions.map((submission) => (
              <Card key={submission.id} className="border mesh-gradient">
                <CardHeader>
                  <CardTitle className="text-lg text-gray-900">{submission.title}</CardTitle>
                </CardHeader>
                <CardFooter className="flex justify-between items-center">
                  <span className="text-gray-600">Votes: {submission.votes}</span>
                  <Button
                    variant="outline"
